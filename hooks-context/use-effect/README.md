...
![pic](https://github.com/netology-code/ra16-homeworks/blob/master/hooks-context/use-effect/assets/use-effect.png)

При первой загрузке ни один из элементов не выбран, поэтому отображается только список:

![pic](https://github.com/netology-code/ra16-homeworks/blob/master/hooks-context/use-effect/assets/first-load.png)
